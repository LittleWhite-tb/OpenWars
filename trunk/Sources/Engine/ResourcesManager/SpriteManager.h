...
{
private:
	std::map<std::string, SDL_Surface*> spriteBank;			/*!< Bank of sprites already loaded */
 ...
 * If the sprite is not known, it will be loaded using IMG_Load() (SDL_image)
 * If the sprite is already known, we just return the pointer on it (SDL_Surface)
 *
